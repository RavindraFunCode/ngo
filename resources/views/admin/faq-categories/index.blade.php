        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div id="table-container">
                    @include('admin.faq-categories.partials.table')
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    function fetch_data(page) {
        $.ajax({
            url: "{{ route('admin.faq-categories.index') }}?page=" + page,
            success: function(data) {
                $('#table-container').html(data);
                window.history.pushState("", "", "{{ route('admin.faq-categories.index') }}?page=" + page);
            }
        });
    }
</script>
