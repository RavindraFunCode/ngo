    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form id="createForm" action="{{ route('admin.faq-categories.store') }}" method="POST">
                    @csrf
                            ...
                            <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="lang-{{ $language->code }}" role="tabpanel">
                                <div class="mt-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="name_{{ $language->code }}" name="translations[{{ $language->code }}][name]" maxlength="255">
                                    </div>
                                </div>
                            </div>
                        @endforeach
